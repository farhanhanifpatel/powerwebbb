  ...
  return (
    <div className="bg-white dark:bg-black text-gray-800 dark:text-gray-200">
      ...
      <section className="relative h-[300px] md:h-[380px] w-full overflow-hidden">
        {/* Background Image */}
        <Image
          src="/cropped-PowerWeb-Logo.webp" // 👉 put your image inside public folder
          alt="Privacy Policy"
          fill
          priority
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-purple-900/80 to-indigo-900/70" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6">
          ...
          <p className="mt-4 max-w-2xl text-sm md:text-base text-gray-200">
            Your trust matters to us. This policy explains how we collect, use,
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <div
          className="bg-gradient-to-b from-purple-50/50 to-white 
                  dark:from-neutral-900 dark:to-black
                  border border-purple-100 dark:border-neutral-800
                  rounded-2xl p-8 md:p-12"
        >
          <div className="space-y-10 text-[15px] leading-7 text-gray-600 dark:text-gray-400">
            {/* Header */}
            <div className="border-l-4 border-purple-600 pl-5">
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                Privacy Policy
              </h1>
              <p className="text-sm mt-1">Last updated: April 19, 2024</p>
            </div>
            ...
            <section className="max-w-5xl mx-auto px-6 py-12">
              <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md border border-gray-100 dark:border-gray-800 p-8 md:p-12">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-8">
                  Definitions
                </h2>

                <ul className="space-y-5 text-gray-600 dark:text-gray-300 leading-relaxed">
                  <li>
                  ...
                  <li>
                    ...
                    An entity that controls or is under common control.
                  </li>
                  ...
                  <li>
                    ...
                    the Company. This includes third-party companies or
                    individuals employed to facilitate the Service, provide the
                    Service on behalf of the Company, perform related services,
                    or assist in analyzing how the Service is used.
                  </li>
            ...
            <div className="border-t border-purple-100 dark:border-neutral-800 pt-10 space-y-6">
            ...
            <div className="border-t border-purple-100 dark:border-neutral-800 pt-10">
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                  Usage Data
                </h2>

                <ul className="list-disc pl-6 space-y-4 text-gray-600 dark:text-gray-300 leading-relaxed">
                  <li>
            ...
            <div className="border-t border-purple-100 dark:border-neutral-800 pt-10">
              <div className="space-y-6">
                ...
                <ul className="list-disc pl-6 space-y-4 text-gray-600 dark:text-gray-300 leading-relaxed">
                  <li>
                    <strong>Necessary / Essential Cookies Types:</strong>{" "}
                    Session Cookies. Administered by: Us. Purpose: These Cookies
                    are essential to provide You with services available through
                    the Website and to enable You to use some of its features.
                    They help to authenticate users and prevent fraudulent use
                    of user accounts. Without these Cookies, the services that
                    You have asked for cannot be provided.
                  </li>

                  <li>
                    <strong>
                      Cookies Policy / Notice Acceptance Cookies Types:
                    </strong>{" "}
                  ...
                  <li>
                    <strong>Functionality Cookies Type:</strong> Persistent
                    Cookies. Administered by: Us. Purpose: These Cookies allow
                    us to remember choices You make when You use the Website,
                    such as remembering your login details or language
              ...
              <div className="space-y-6">
                ...
                <ul className="list-disc pl-6 space-y-4 text-gray-600 dark:text-gray-300 leading-relaxed">
                  <li>
                    ...
                    including to monitor the usage of our Service.use these
            ...
            <div className="border-t border-purple-100 dark:border-neutral-800 pt-12">
              <section className="max-w-4xl mx-auto px-6">
                <div className="space-y-10 text-gray-700 dark:text-gray-300 leading-relaxed">
                  {/* Business Transactions */}
                  <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 shadow-sm hover:shadow-md transition-shadow duration-300 border border-purple-100 dark:border-neutral-800">
                  ...
                  <div className="p-6 rounded-2xl bg-white dark:bg-neutral-900 shadow-sm hover:shadow-md transition-shadow duration-300 border border-purple-100 dark:border-neutral-800">
                    ...
                    <ul className="mt-4 list-disc pl-6 space-y-2 marker:text-purple-600">
            ...
            <div className="border-t border-purple-100 dark:border-neutral-800 pt-10">
              <div className="space-y-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  sites or services. ent’s consent before We collect and use
                  that information.
                </p>
              </div>
            </div>
            ...
            <div className="border-t border-purple-100 dark:border-neutral-800 pt-8">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                Contact Us
              </h2>
              ...
              <ul>
                <li>
                  <strong>By email : </strong>info@powerweb.qa
                </li>
                <li>
                  <strong>By visiting this page on our website: </strong>
                  <a
                    href=" https://www.powerweb.qa/contact-us"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-purple-600 hover:underline"
                  >
                    https://www.powerweb.qa/contact-us
                  </a>
                </li>
              </ul>
            </div>
