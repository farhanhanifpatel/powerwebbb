      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold leading-tight mb-6">
            Let’s Connect and Design Your Website
          </h2>

          <p className="max-w-3xl mx-auto text-lg text-purple-100 leading-relaxed mb-10">
            Ready to transform your digital presence with professional
            <span className="font-semibold text-white"> web design Qatar </span>
            services? PowerWeb combines technical excellence with creative
            innovation to deliver websites that drive results. Our team is
            committed to your success, providing personalized attention and
            ongoing support to help your business thrive in Qatar’s competitive
            marketplace.
          </p>
